...
const AnimatedSVGMobile = () => {
  return (
    <motion.svg
      ...
      version="1.1"
      viewBox="0 0 1000 1000" // Ajusta según las proporciones deseadas
      width="100%"
      height="auto"
      preserveAspectRatio="xMidYMid meet" // Mantiene el SVG centrado
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
...
<motion.rect //1er brillo
  ...
  transition={{
    opacity: {
      duration: 0.5,
      delay: 4 // Ajusta este valor según necesites
    }
  }}
/>
