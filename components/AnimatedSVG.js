...
const montserrat = Montserrat({ 
  subsets: ['latin'],
  // Opcionalmente puedes especificar weights
  weight: ['900', '900'],
  // Y variables CSS
...
const AnimatedSVG = () => {
  return (
    <motion.svg
      ...
      width="1400px" // o un valor específico como "500px"
      height="700px" // o un valor específico
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      />
      <motion.g id="Circuitos" initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 0.5, duration: 0.3 }}>
...
<motion.rect //1er brillo
  ...
  transition={{
    opacity: {
      duration: 0.5,
      delay: 3 // Ajusta este valor según necesites
    }
  }}
/>
...
/>
      ...
      <motion.path
        ...
        <motion.g id="derecha" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
          <motion.path
            fill="#fff"
...
/>
    ...
    <motion.g id="Cerebro_contorno" initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 0.5, duration: 0.5 }}>
        <motion.path
          fill="#fff"
...
<motion.text
  ...
  transition={{ 
    opacity: { duration: 0.2, delay: 3.2 },
    filter: { 
      duration: 1.2,
      delay: 3.2
    }
